                                ...
                                <tbody>
                                    ...
                                    <?php
                                        if( ! empty($customer)){ // Jika data pegawai tidak sama dengan kosong, artinya jika data pegawai ada
                                            ...
                                            <td>".$data->instansi."</td>
                                            <td><a href='".base_url("customer/ubah/".$data->id)."' class='edit'> <i class='material-icons' title='Edit'>&#xE254;</i></a>
                                                <a href='".base_url("customer/hapus/".$data->id)."' class='delete'><i class='material-icons' title='Delete'>&#xE872;</i></td>
                                            </tr>";
                                            }
